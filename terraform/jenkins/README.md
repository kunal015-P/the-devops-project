...
**Important**: This Terraform configuration expects an AWS Key Pair named "jenkins" to already exist in your AWS account.
...
- **Security Group**: jenkins-8080 (allows SSH and Jenkins port)
- **Key Pair**: jenkins (must exist in AWS)
...
ssh -i "jenkins.pem" ec2-user@<JENKINS-PUBLIC-IP>
```
